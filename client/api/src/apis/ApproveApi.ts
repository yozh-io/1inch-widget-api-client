...
export class ApproveApi extends runtime.BaseAPI {
     ...
     */
    async approveFactoryControllerGetAllowanceRaw(requestParameters: ApproveFactoryControllerGetAllowanceRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
     ...
     * Get the number of tokens that the 1inch router is allowed to spend
     */
    async approveFactoryControllerGetAllowance(requestParameters: ApproveFactoryControllerGetAllowanceRequest, initOverrides?: RequestInit): Promise<void> {
        await this.approveFactoryControllerGetAllowanceRaw(requestParameters, initOverrides);
    }

    /**
     * Generate data for calling the contract in order to allow the 1inch router to spend funds
     */
    async approveFactoryControllerGetCallDataRaw(requestParameters: ApproveFactoryControllerGetCallDataRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApproveCalldataResponseDto>> {
        if (requestParameters.tokenAddress === null || requestParameters.tokenAddress === undefined) {
     ...
     * Generate data for calling the contract in order to allow the 1inch router to spend funds
     */
    async approveFactoryControllerGetCallData(requestParameters: ApproveFactoryControllerGetCallDataRequest, initOverrides?: RequestInit): Promise<ApproveCalldataResponseDto> {
        const response = await this.approveFactoryControllerGetCallDataRaw(requestParameters, initOverrides);
     ...
     */
    async approveFactoryControllerGetSpenderRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<ApproveSpenderResponseDto>> {
        const queryParameters: any = {};
     ...
     * Address of the 1inch router that must be trusted to spend funds for the exchange
     */
    async approveFactoryControllerGetSpender(initOverrides?: RequestInit): Promise<ApproveSpenderResponseDto> {
        const response = await this.approveFactoryControllerGetSpenderRaw(initOverrides);
        return await response.value();
    }
