...
export interface SwapFactoryCommonControllerGetQuoteRequest {
...
export interface SwapFactoryCommonControllerGetSwapRequest {
    fromTokenAddress: string;
    toTokenAddress: string;
    amount: string;
    fromAddress: string;
...
export class SwapApi extends runtime.BaseAPI {
     ...
     */
    async swapFactoryCommonControllerGetQuoteRaw(requestParameters: SwapFactoryCommonControllerGetQuoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<QuoteResponseDto>> {
        if (requestParameters.fromTokenAddress === null || requestParameters.fromTokenAddress === undefined) {
            throw new runtime.RequiredError('fromTokenAddress','Required parameter requestParameters.fromTokenAddress was null or undefined when calling swapFactoryCommonControllerGetQuote.');
        }

        if (requestParameters.toTokenAddress === null || requestParameters.toTokenAddress === undefined) {
            throw new runtime.RequiredError('toTokenAddress','Required parameter requestParameters.toTokenAddress was null or undefined when calling swapFactoryCommonControllerGetQuote.');
        }

        if (requestParameters.amount === null || requestParameters.amount === undefined) {
            throw new runtime.RequiredError('amount','Required parameter requestParameters.amount was null or undefined when calling swapFactoryCommonControllerGetQuote.');
        }
     ...
     * Find the best quote to exchange via 1inch router
     */
    async swapFactoryCommonControllerGetQuote(requestParameters: SwapFactoryCommonControllerGetQuoteRequest, initOverrides?: RequestInit): Promise<QuoteResponseDto> {
        const response = await this.swapFactoryCommonControllerGetQuoteRaw(requestParameters, initOverrides);
     ...
     */
    async swapFactoryCommonControllerGetSwapRaw(requestParameters: SwapFactoryCommonControllerGetSwapRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<SwapResponseDto>> {
        if (requestParameters.fromTokenAddress === null || requestParameters.fromTokenAddress === undefined) {
            throw new runtime.RequiredError('fromTokenAddress','Required parameter requestParameters.fromTokenAddress was null or undefined when calling swapFactoryCommonControllerGetSwap.');
        }

        if (requestParameters.toTokenAddress === null || requestParameters.toTokenAddress === undefined) {
            throw new runtime.RequiredError('toTokenAddress','Required parameter requestParameters.toTokenAddress was null or undefined when calling swapFactoryCommonControllerGetSwap.');
        }

        if (requestParameters.amount === null || requestParameters.amount === undefined) {
            throw new runtime.RequiredError('amount','Required parameter requestParameters.amount was null or undefined when calling swapFactoryCommonControllerGetSwap.');
        }

        if (requestParameters.fromAddress === null || requestParameters.fromAddress === undefined) {
            throw new runtime.RequiredError('fromAddress','Required parameter requestParameters.fromAddress was null or undefined when calling swapFactoryCommonControllerGetSwap.');
        }

        if (requestParameters.slippage === null || requestParameters.slippage === undefined) {
            throw new runtime.RequiredError('slippage','Required parameter requestParameters.slippage was null or undefined when calling swapFactoryCommonControllerGetSwap.');
        }
     ...
     * Generate data for calling the 1inch router for exchange
     */
    async swapFactoryCommonControllerGetSwap(requestParameters: SwapFactoryCommonControllerGetSwapRequest, initOverrides?: RequestInit): Promise<SwapResponseDto> {
        const response = await this.swapFactoryCommonControllerGetSwapRaw(requestParameters, initOverrides);
        return await response.value();
    }
