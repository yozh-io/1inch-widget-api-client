...
function ApproveSpenderResponseDtoFromJSON(json) {
    return ApproveSpenderResponseDtoFromJSONTyped(json, false);
}
exports.ApproveSpenderResponseDtoFromJSON = ApproveSpenderResponseDtoFromJSON;
function ApproveSpenderResponseDtoFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ApproveSpenderResponseDtoFromJSONTyped = ApproveSpenderResponseDtoFromJSONTyped;
function ApproveSpenderResponseDtoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ApproveSpenderResponseDtoToJSON = ApproveSpenderResponseDtoToJSON;
