...
export declare class InfoApi extends runtime.BaseAPI {
     ...
     */
    chainProtocolControllerGetProtocolsImagesRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<ProtocolsResponseDto>>;
    /**
     * List of liquidity sources that are available for routing in the 1inch Aggregation protocol
     */
    chainProtocolControllerGetProtocolsImages(initOverrides?: RequestInit): Promise<ProtocolsResponseDto>;
    /**
