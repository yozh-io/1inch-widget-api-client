...
class SwapApi extends runtime.BaseAPI {
     ...
     */
    swapFactoryCommonControllerGetQuoteRaw(requestParameters, initOverrides) {
     ...
     * Find the best quote to exchange via 1inch router
     */
    swapFactoryCommonControllerGetQuote(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.swapFactoryCommonControllerGetQuoteRaw(requestParameters, initOverrides);
     ...
     */
    swapFactoryCommonControllerGetSwapRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.fromTokenAddress === null || requestParameters.fromTokenAddress === undefined) {
     ...
     * Generate data for calling the 1inch router for exchange
     */
    swapFactoryCommonControllerGetSwap(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.swapFactoryCommonControllerGetSwapRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
