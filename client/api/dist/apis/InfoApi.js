...
class InfoApi extends runtime.BaseAPI {
     ...
     */
    chainProtocolControllerGetProtocolsImagesRaw(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            const response = yield this.request({
     ...
     * List of liquidity sources that are available for routing in the 1inch Aggregation protocol
     */
    chainProtocolControllerGetProtocolsImages(initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.chainProtocolControllerGetProtocolsImagesRaw(initOverrides);
