...
function SwapResponseDtoFromJSON(json) {
    return SwapResponseDtoFromJSONTyped(json, false);
}
exports.SwapResponseDtoFromJSON = SwapResponseDtoFromJSON;
function SwapResponseDtoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'tx': Tx_1.TxFromJSON(json['tx']),
    };
}
exports.SwapResponseDtoFromJSONTyped = SwapResponseDtoFromJSONTyped;
function SwapResponseDtoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tx': Tx_1.TxToJSON(value.tx),
    };
}
exports.SwapResponseDtoToJSON = SwapResponseDtoToJSON;
