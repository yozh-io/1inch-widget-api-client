...
export declare function ApproveCalldataResponseDtoFromJSON(json: any): ApproveCalldataResponseDto;
export declare function ApproveCalldataResponseDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApproveCalldataResponseDto;
export declare function ApproveCalldataResponseDtoToJSON(value?: ApproveCalldataResponseDto | null): any;
