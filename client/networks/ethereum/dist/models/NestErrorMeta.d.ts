...
export declare function NestErrorMetaFromJSON(json: any): NestErrorMeta;
export declare function NestErrorMetaFromJSONTyped(json: any, ignoreDiscriminator: boolean): NestErrorMeta;
export declare function NestErrorMetaToJSON(value?: NestErrorMeta | null): any;
