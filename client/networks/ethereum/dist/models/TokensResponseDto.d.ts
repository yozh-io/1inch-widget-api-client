...
export declare function TokensResponseDtoFromJSON(json: any): TokensResponseDto;
export declare function TokensResponseDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TokensResponseDto;
export declare function TokensResponseDtoToJSON(value?: TokensResponseDto | null): any;
