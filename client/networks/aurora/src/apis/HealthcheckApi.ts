...
export class HealthcheckApi extends runtime.BaseAPI {
     ...
     * API health check
     */
    async factoryHealthCheckControllerHealthcheckRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};

        const response = await this.request({
            path: `/v5.0/1313161554/healthcheck`,
            method: 'GET',
     ...
     * API health check
     */
    async factoryHealthCheckControllerHealthcheck(initOverrides?: RequestInit): Promise<void> {
        await this.factoryHealthCheckControllerHealthcheckRaw(initOverrides);
    }
