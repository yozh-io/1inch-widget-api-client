 ...
 */
import { ProtocolImageDto } from './ProtocolImageDto';
/**
 *
 * @export
...
export declare function ProtocolsResponseDtoFromJSON(json: any): ProtocolsResponseDto;
export declare function ProtocolsResponseDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProtocolsResponseDto;
export declare function ProtocolsResponseDtoToJSON(value?: ProtocolsResponseDto | null): any;
