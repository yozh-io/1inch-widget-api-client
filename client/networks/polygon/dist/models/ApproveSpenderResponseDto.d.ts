...
export declare function ApproveSpenderResponseDtoFromJSON(json: any): ApproveSpenderResponseDto;
export declare function ApproveSpenderResponseDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApproveSpenderResponseDto;
export declare function ApproveSpenderResponseDtoToJSON(value?: ApproveSpenderResponseDto | null): any;
